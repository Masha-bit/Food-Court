...
export default function Splash() {
  return (
    ...
    <div id="main" className='h-screen w-screen bg-[#FFC83A] flex items-center justify-center font-dongle'>
      ...
      <div className='h-[90%] w-[80%] flex flex-col p-4 mt-[10rem]'>
        ...
        <p className=' w-[100%] text-center text-[14px] text-slate-400'>We noticed you opened this on a desktop.This application was designed to give maximum user experience to mobile users. Try opening this site on a mobile device</p>
      </div>
