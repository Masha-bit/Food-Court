...
export default function Login() {
  ...
  return (
    <div className='mt-[5rem] mx-auto h-[50%] w-[80%] font-dongle'>
          <form>
        <div>
        <label htmlFor="login_email" className=' text-gray-500 text-[16px]'>Email address</label>
        ...
        <label htmlFor="login_password" className=' text-gray-500 text-[16px]'>Password</label>
        ...
        <div className='text-[14px] text-[rgb(255,0,0)] font-bold mt-9 underline underline-[rgb(255,0,0)]'>Forgot passcode?</div>
