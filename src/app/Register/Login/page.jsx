...
export default function Login() {
  ...
  return (
    <div className='mt-[5rem] mx-auto h-[50%] w-[80%] font-dongle'>
        ...
        <input type="email" name="login_email" id="login_email" className='block w-[100%] h-[40px] border-b-2 bg-transparent border-black px-2 outline-none' onChange={validateUserEmail} required/>
        </div>

        
        <div className='mt-[4rem]'>
        <label htmlFor="login_password" className=' text-gray-500 text-[25px]'>Password</label>
        <input type="password" name="login_password" id="login_password" className='text-[20px] block w-[100%] h-[40px] border-b-2 bg-transparent border-black px-2 outline-none' onChange={validateUserPassword} required/>
        </div>
